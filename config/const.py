...
def init_dataset_setting_spotify():
    ...
    query_id_dim = 16
    query_search_source_num = 1 #since there isn't search source for spotify dataset. this can be seen as a bias vector for all query embedding
