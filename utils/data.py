...
class SESRec_neg_sample_Dataset(BaseDataset):
    def __init__(self,  dataset_file, flags_obj):
        ...
        self.our_get_item = self.commercial__getitem__ if self.dst_name == 'commercial' else self.spotify__getitem__
    ...
    def spotify__getitem__(self, index):
        '''
        the same as above
        '''
