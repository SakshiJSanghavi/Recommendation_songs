...
class Pair_Sampler(Sampler):
    ...
    def build(self, args):
        ...
        self._get_user_profile = self.commercial_get_user_profile if self.dataset_name == 'commercial' else self.spotify_get_user_profile
        self._get_item_info = self.commercial_get_item_info if self.dataset_name == 'commercial' else self.spotify_get_item_info
    ...
    def spotify_get_user_profile(self, user):
    ...
    def spotify_get_item_info(self, item):
        if item == 0:
            # skip padding
            return (0,)
