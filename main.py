if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='spotify')
    ...
    elif args.dataset_name == 'spotify':
        const.init_dataset_setting_spotify()
        data_in.init_data_attribute_ls('spotify')
    else:
